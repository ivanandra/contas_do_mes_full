...
import { Trash2, Calendar, Filter, ShoppingBag, Plus, X } from 'lucide-react'
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      {showForm && (
        <div className="card p-5 space-y-4 animate-fade-in">
          <h3 className="font-semibold text-white text-sm">Novo gasto avulso</h3>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-dark-400 text-dark-800 text-xs uppercase tracking-wider">
                ...
                <th className="px-5 py-3 text-left hidden sm:table-cell">Categoria</th>
            ...
            <tbody className="divide-y divide-dark-400">
              {expenses.map((e) => (
                <tr key={e.id} className="hover:bg-dark-300/50 transition-colors">
                  ...
                  <td className="px-5 py-3 text-dark-800 hidden sm:table-cell">
                    {e.category ?? '—'}
                  </td>
                  ...
                  <td className="px-5 py-3 text-right">
                    <button
                      ...
                      className="w-7 h-7 rounded-lg flex items-center justify-center ml-auto text-dark-700 hover:bg-red-500/10 hover:text-red-400 transition-colors"
                    >
                      <Trash2 size={14} />
                    </button>
                  </td>
