...
export default function Header() {
  ...
  return (
    <header className="h-16 bg-dark-100 border-b border-dark-400 px-6 flex items-center justify-between shrink-0">
      <div>
        <h1 className="text-lg font-bold text-white">{page.title}</h1>
        {page.subtitle && <p className="text-xs text-dark-800">{page.subtitle}</p>}
      </div>
