...
/**
 * Botão customizado de login com Google.
 * Visual igual ao botão "Entrar" — mantém consistência do app.
 * Usa popup OAuth (access_token), o backend converte via userinfo.
 */
export function GoogleButton({ onSuccess, onError, loading: externalLoading }: Props) {
